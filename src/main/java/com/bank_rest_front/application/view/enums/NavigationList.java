...
public class NavigationList extends ArrayList<HorizontalLayout> {
    ...
    public NavigationList(UserDetails user) {
        this.user = user;
        add(VaadinIcon.HOME, "Главная", StartPageView.class);
        add(VaadinIcon.MONEY_EXCHANGE, "Платежи", PaymentsView.class);
        add(VaadinIcon.CREDIT_CARD, "Заявки на создание карт", CreateCardApplicationsView.class);
    }
